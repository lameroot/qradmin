...
public class MerchantController extends GenericController<Merchant, MerchantDto, MerchantFilterDto> {
    ...
    @Override
    protected GenericDtoService<Merchant, MerchantDto, MerchantFilterDto> getDtoService() {
